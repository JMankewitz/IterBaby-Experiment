...
class ExpPresentation(Exp):
	...
	def initializeExperiment(self):
		...
		# Load Trials
		familiarizationTrialPath = 'orders/familiarizationTrialOrders/IterBaby_Order' + self.experiment.subjVariables['order'] +".csv"
		activeTrainingTrialPath = 'orders/activeTrainingOrders/IterBaby_ActiveTrainingOrder' + self.experiment.subjVariables['order'] +".csv"
		activeTestTrialPath = 'orders/activeOrders/IterBaby_ActiveOrder' + self.experiment.subjVariables['order'] +".csv"
		lwlTrialPath = 'orders/lwlOrders/IterBaby_LWLOrder' + self.experiment.subjVariables['order'] +".csv"
	...
	def presentScreen(self, screen):
		from psychopy import event  # Add this at the top of your file

		print("About to present screen")
